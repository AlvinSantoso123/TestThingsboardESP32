...
constexpr char WIFI_SSID[] PROGMEM = "PCU_Sistem_Kontrol";
constexpr char WIFI_PASSWORD[] PROGMEM = "lasikonn";
#else
constexpr char WIFI_SSID[] = "PCU_Sistem_Kontrol";
constexpr char WIFI_PASSWORD[] = "lasikonn";
#endif
...
#if THINGSBOARD_ENABLE_PROGMEM
constexpr char THINGSBOARD_SERVER[] PROGMEM = "192.168.138.52";
#else
constexpr char THINGSBOARD_SERVER[] = "192.168.138.52";
#endif
